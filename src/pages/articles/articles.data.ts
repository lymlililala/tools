...
→ Try the [BIP39 Generator](/bip39-generator)`,
  ...
  // ─── Converter ────────────────────────────────────────────────
  {
    ...
    description: 'Learn what Base64 encoding is, how to encode and decode strings and files, when (and when not) to use it, and how it compares to hex and binary encoding.',
...
-> Try the [Color Converter](/color-converter)`,
  },
  {
    ...
    description: 'Convert Markdown to clean HTML instantly. Learn Markdown syntax, popular flavors (CommonMark, GFM), and best practices for writing and publishing.',
...
`,
  },
  {
    ...
    description: 'Convert between decimal numbers and Roman numerals. Learn the rules, symbols, subtraction principle, and the fascinating history behind Roman numerals.',
...
-> Try the [JSON Formatter & Validator](/json-format)`,
  },
  {
    ...
    description: 'Master Unix and Linux file permissions. Learn rwx notation, octal values, special bits (setuid, setgid, sticky), and use our chmod calculator.',
...
-> Try the [JSON Diff Tool](/json-diff)`,
  },
  {
    ...
    description: 'Format and validate XML documents online. Learn XML structure, namespaces, attributes, and common parsing errors. Pretty-print minified XML with syntax highlighting and error detection.',
...
-> Try the [XML Formatter](/xml-format)`,
  },
  {
    ...
    description: 'Format and validate YAML files online. Learn YAML syntax, indentation rules, common errors, and best practices for Kubernetes, Docker Compose, and GitHub Actions configs.',
...
-> Try the [MAC Address Generator](/mac-address-generator)`,
  ...
  // ─── Math ─────────────────────────────────────────────────────
  {
    ...
    description: 'Learn all types of percentage calculations: X% of Y, percentage change between two values, and what percent X is of Y — with formulas and examples.',
...
-> Try the [Mortgage Calculator](/mortgage-calculator)`,
  },
  {
    ...
    description: 'Evaluate mathematical expressions, use variables, and compute scientific functions (trig, log, sqrt) directly in your browser — no installation needed.',
...
`,
  },
  {
    ...
    description: 'Convert JSON arrays to CSV format for use in Excel, Google Sheets, and data analysis tools. Automatically detects column headers, handles nested objects, and supports one-click download.',
...
`,
  },
  {
    ...
    description: 'Convert any text into a URL-friendly slug instantly. Learn best practices for SEO-friendly URL structure, handle accents and special characters, and generate clean permalink paths.',
...
`,
  },
  {
    ...
    description: 'Learn what numeronyms are (like i18n, k8s, a11y), why they exist in tech culture, and generate numeronyms for any word. Explore common examples used in software development teams.',
...
`,
  },
  {
    ...
    description: 'Expand a CIDR block or IP range into a complete list of individual IP addresses. Useful for firewall rule generation, network audits, and subnet analysis.',
...
`,
  },
  {
    ...
    description: 'Look up the vendor and manufacturer of any network device using its MAC address OUI prefix. Search the IEEE database to identify device brands for network audits and security troubleshooting.',
...
`,
  },
  {
    ...
    description: 'Use our browser-based WYSIWYG editor to create formatted HTML content without writing code. Export clean semantic HTML5, preview in real time, and use for emails, CMS content, and web pages.',
...
`,
  },
  {
    ...
    description: 'Convert text to binary (0s and 1s) representation and back. Learn how computers represent characters using ASCII and UTF-8 encoding, with interactive bit-by-bit breakdown for each character.',
...
`,
  },
  {
    ...
    description: 'Minify JSON by removing all whitespace and formatting. Learn when to minify JSON for production vs keep it formatted for debugging, and how much size reduction to expect in API responses.',
